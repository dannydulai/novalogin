...
<div class="guttered" style="display: flex; align-items: center; justify-content: center;">
    ...
    <div v-if="auth_state === 'appforbidden'" class="box">
        <div style="text-align: center; font-size: 3rem; font-family: var(--font-2); padding-bottom: 1rem;">
            Access Forbidden
        </div>
        <div>
            <div style="margin-bottom: 12px;">
                ...
                You do not have access to <b>{{forbiddenname}}</b>.<br><br>
                </p>
                <button @click="gotoaccount" style="display: flex; justify-content: center; align-items: center; margin-top: 12px; margin-bottom: 12px;">
                    Click here to go to your account
                </button>
            </div>
        </div>
    </div>
    <div v-else-if="auth_state === 'confirmapp'" class="box">
        <div style="text-align: center; font-size: 3rem; font-family: var(--font-2); padding-bottom: 1rem;">
            <pr-text path='t.welcome_back'/>
        </div>
        <form id="form">
...
export default {
    ...
    methods: {
        gotoaccount() {
            window.location.href = 'https://account.roon.app/account';
        },
